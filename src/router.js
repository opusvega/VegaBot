...
let apiWelcomeController = require('./welcome/api/controller/welcomeApiHandler.js');
let fs = require('fs');
 ...
 app.get("/", function(req, res) {
    ...
    app.post('/hook', async function(req, res) {
        ...
        if(req.body.result.metadata.intentName == "DefaultWelcomeIntent"){
            ...
            await apiWelcomeController.apiDefaultWelcomeIntent(req, res);
        ...
        if(req.body.result.metadata.intentName == "DefaultWelcomeIntent-get-username"){
            ...
            await apiWelcomeController.apiDefaultWelcomeIntentGetUsername(req, res);
        ...
        if(req.body.result.metadata.intentName == "DefaultWelcomeIntent-forgot-username"){
            ...
            await apiWelcomeController.apiDefaultWelcomeIntentForgotUsername(req, res);
        ...
        if(req.body.result.metadata.intentName == "DefaultWelcomeIntent-forgot-username-get-email"){
            ...
            await apiWelcomeController.apiDefaultWelcomeIntentForgotUsernameGetEmail(req, res);
        ...
        if(req.body.result.metadata.intentName == "DefaultWelcomeIntent-forgot-username-get-otp"){
            ...
            await apiWelcomeController.apiDefaultWelcomeIntentForgotUsernameGetOtp(req, res);
